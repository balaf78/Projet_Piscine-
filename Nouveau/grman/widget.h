...
class WidgetImage : public Widget
{
    ...
    public :
        ...
        /// Méthode ajoutée : l'idée est de pouvoir récupérer le nom d'une image après lecture d'un fichier afin de pouvoir de l'attribuer à chaques
        ///sommets contenu dans m_verticies (voir graphe.cpp ligne 77 et 286 pour plus de compréhension)
...
class WidgetEdge : public Widget
{
    ...
    public :
        ...
        Widget* get_from(){return m_attach[0];}
        Widget* get_to(){return m_attach[1];}
