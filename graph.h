...
class Edge
{
    ...
    private :
        ...
        ///seulement pour la lecture du fichier
        int m_identifiant;
...
class Graph
{
    private :
        ...
        ///Sert seulement à la lecture des fichiers
        std::vector<Vertex> m_sommets;
        std::vector<Edge> m_aretes;
    ...
    public:
        ...
        /// Initialise le graphe par lecture de fichier
        void Initialiser_graphe(int saisie);

        void sauvegarderGraphe(int saisie);
